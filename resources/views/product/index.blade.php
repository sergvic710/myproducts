...
@section('content')
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
        <div class="flex items-center justify-between flex-column md:flex-row flex-wrap space-y-4 md:space-y-0 py-4 bg-white">
            <div>
                <a href="{{ route('product.create') }}" class="text-blue-700 hover:text-white border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Add</a>
...
{{--                        <li>--}}
{{--                            <a href="#" class="block px-4 py-2 hover:bg-gray-100">Add</a>--}}
{{--                        </li>--}}
{{--                        <li>--}}
            ...
            @foreach($products as $item)
                <tr class="bg-white border-b hover:bg-gray-50">
                    ...
                    <th scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap">
                        ...
                        <img class="w-10 h-10 rounded-full" src="{{ $item->getMedia('image')[0]->getUrl() }}" alt="Jese image">
                        @endif
                        <div class="ps-3">
                    ...
                    <td class="px-6 py-4">
                        <div class="inline-flex rounded-md shadow-sm">
                            ...
                            <a href="{{ route('product.edit', $item->id) }}" class="text-blue-700 hover:text-white border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Edit</a>
